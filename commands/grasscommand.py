...
class GrassCommand( BaseCommand ):

     def __init__(self):
          BaseCommand.__init__( self )
          self.command_mappings = [ "grass" ]
          self.templates = [  Template("Knows this much, but ain't saying no more... "),
                            ]
     ...
     def generate( self, name ):
          ...
          url='http://ephemera.shardcore.no-ip.org/cgi-bin/grassUp.pl'
