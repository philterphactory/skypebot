...
class PurpsCommand( BaseCommand ):
    ...
    def __init__(self):
        ...
        self.templates = [  Template("likes his whiskey."),
                            ...
                            Template("tries to leave."),
                            Template("is hustling for a contract."),
                            Template("bollocks the pitch team."),
                            Template("books a train."),
                            Template("brings an extension cable with him to the conference."),
                            Template("is dragged back into the bar by !landy."),
