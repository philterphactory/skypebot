...
class ClientCommand( BaseCommand ):
    ...
    def __init__(self):
        ...
        self.templates = [  Template("asks $name if they could make a microsite to go with the project."),
                            ...
                            Template("isn't quite feeling it."),
                            Template("wants to send it for another round of QA testing."),
                            Template("has had a strategy pivot."),
                            Template("demands the moon on a stick."),
                            Template("learnt a new word today."),
                            Template("floods Basecamp."),
                            Template("reckons a Facebook page would be more effective."),
                            Template("wants $name to run that by him one more time."),
                            Template("wants $name to go away and iterate a few more versions."),
                            Template("can definitely see what $name is trying to do."),
                            Template("wants to foreground the brand more."),
                            Template("thinks it should incorporate community content."),
                            Template("preferred the previous version. The one from three months ago."),
                            Template("can't see it getting past compliance."),
